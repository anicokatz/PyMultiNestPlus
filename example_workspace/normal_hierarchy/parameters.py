...
t13 = ['t13', 'periodic', 0, 2*np.pi, 'gaussian', 0.147, 0.003]
dm2 = ['dm2', 'real', -1000, 1000, 'gaussian', 7.56*(10**(-5)), 0.24*(10**(-5))]
Dm2 = ['Dm2', 'real', -1000, 1000, 'gaussian', 2.45*(10**(-3)), 0.07*(10**(-3))]
...
scanning = [ml, phi1, phi2, t12, t13, dm2, Dm2] # we are scanning over rad and theta
nuisance = [] # phi is treated as a nuisance parameter
